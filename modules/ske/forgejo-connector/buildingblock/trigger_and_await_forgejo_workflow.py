...
def main() -> None:
    ...
    while True:
        ...
        if tasks:
            ...
            # print alternative info so we can distinguish between a job not running or a job timeout
            elapsed = int((dt.datetime.now(dt.timezone.utc) - dispatch_at).total_seconds())

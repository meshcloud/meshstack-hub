...
resource "aws_iam_policy" "buildingblock_route53_alias_record_policy" {
  name        = "Route53AliasRecordBuildingBlockFederatedPolicy-${random_string.name_suffix.result}"
...
resource "aws_iam_role" "assume_federated_role" {
  name               = "BuildingBlockRoute53AliasRecordIdentityFederation-${random_string.name_suffix.result}"
...
moved {
  from = aws_iam_role_policy_attachment.buildingblock_route53_alias_record[0]
  to   = aws_iam_role_policy_attachment.buildingblock_route53_alias_record
}

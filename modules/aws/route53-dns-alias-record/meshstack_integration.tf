...
resource "meshstack_building_block_definition" "this" {
  ...
  spec = {
    ...
    symbol            = "https://raw.githubusercontent.com/meshcloud/meshstack-hub/main/modules/aws/route53-dns-alias-record/buildingblock/logo.png"
  ...
  version_spec = {
    ...
    inputs = {
      ...
      zone_name = {
        ...
        description     = "AWS Route53 hosted zone name in which the alias record will be created (e.g. 'example.com')."
      ...
      type = {
        ...
        description     = "DNS record type for the alias. Must be A or AAAA."
        assignment_type = "USER_INPUT"
      }
      alias_name = {
        type            = "STRING"

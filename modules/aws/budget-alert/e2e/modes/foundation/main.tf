...
# terraform state, so a foundation smoke test needs no credential beyond a meshStack API key — and
# the test targets what a user of the foundation actually sees.

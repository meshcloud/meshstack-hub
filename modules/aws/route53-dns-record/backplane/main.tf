...
resource "aws_iam_user" "buildingblock_route53_record_user" {
  ...
  name = "buildingblock-route53-record-user"
}
...
resource "aws_iam_policy" "buildingblock_route53_record_policy" {
  name        = var.workload_identity_federation == null ? "Route53RecordBuildingBlockPolicy" : "Route53RecordBuildingBlockFederatedPolicy"

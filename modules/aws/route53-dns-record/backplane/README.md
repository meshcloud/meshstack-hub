...
This deploys the IAM role that the Route53 DNS Record building block assumes to manage records in the
hosted zones you list.
...
| <a name="requirement_random"></a> [random](#requirement\_random) | >= 3.0, < 4.0.0 |

...
| <a name="requirement_aws"></a> [aws](#requirement\_aws) | >= 6.32, < 7.0.0 |
...
| <a name="input_record"></a> [record](#input\_record) | DNS record value. You can specify multiple values separated by commas (e.g., "ns1.example.com,ns2.example.com" or "192.168.1.1,192.168.1.2"). | `string` | n/a | yes |

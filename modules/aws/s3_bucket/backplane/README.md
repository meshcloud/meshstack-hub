...
| <a name="requirement_aws"></a> [aws](#requirement\_aws) | >= 6.12.0, < 7.0.0 |
...
|------|-------------|------|---------|:--------:|
| <a name="input_name"></a> [name](#input\_name) | Name for the backplane IAM role and policy (suffixed -role and -policy). | `string` | n/a | yes |

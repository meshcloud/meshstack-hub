...
variable "folder_id" {
  type        = string
  nullable    = false
  description = "STACKIT folder ID under which the tenant projects live. The service account is granted 'model-serving.editor' on this folder, which covers every project below it."
}

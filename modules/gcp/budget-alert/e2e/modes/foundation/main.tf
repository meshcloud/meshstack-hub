...
# terraform state. That keeps this smoke test down to one credential, the meshStack API key — the
# deployment's state also holds the backplane's GCP credentials — and it targets what a user of the

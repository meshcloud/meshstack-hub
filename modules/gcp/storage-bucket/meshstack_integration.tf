...
module "backplane" {
  ...
  workload_identity_federation_trust = {
    issuer   = meshstack_building_block_definition.gcp_storage_bucket.status.workload_identity_federation.issuer
    audience = meshstack_building_block_definition.gcp_storage_bucket.status.workload_identity_federation.gcp.audience
    subjects = [meshstack_building_block_definition.gcp_storage_bucket.status.workload_identity_federation.subject]
  }
}

---
name: meshStack Composition Building Block
supportedPlatforms:
  - meshstack
description: |
...
---
# meshStack Composition Building Block
...
| <a name="input_name"></a> [name](#input\_name) | Name used for the building block definition and building block this composition creates. | `string` | n/a | yes |

...
# use following Environment variables to configure your Building Blocki Definition for the Terraform azurerm/azuread Provider:
...
# Role definition ID to assign to the GitHub Actions App Service Managed Identity. This is used to deploy resources via Terraform.

...
| <a name="input_georeplications"></a> [georeplications](#input\_georeplications) | List of geo-replication configurations (Premium SKU only) | <pre>list(object({<br>    location                  = string<br>    zone_redundancy_enabled   = bool<br>    regional_endpoint_enabled = bool<br>  }))</pre> | `[]` | no |

...
supportedPlatforms:
  - azure
description: |
  (ALPHA) Provisions a Linux Azure Virtual Machine (VM) including network interface, optional public IP, network security group, and optional data disk.
---

# Azure Virtual Machine

This Terraform module provisions a Linux Azure Virtual Machine along with necessary networking components and optional data disks.
...
| Name | Version |
|------|---------|
| <a name="requirement_azuread"></a> [azuread](#requirement\_azuread) | >= 3.6.0, < 4.0.0 |
| <a name="requirement_azurerm"></a> [azurerm](#requirement\_azurerm) | >= 4.50.0, < 5.0.0 |
...
| <a name="input_ssh_public_key"></a> [ssh\_public\_key](#input\_ssh\_public\_key) | SSH public key for the VM's admin user. | `string` | n/a | yes |
...
- VMs use SSH key authentication (password authentication disabled)

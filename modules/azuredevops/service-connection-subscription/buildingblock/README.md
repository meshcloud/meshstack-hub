...
|------|-------------|------|---------|:--------:|
| <a name="input_application_id"></a> [application\_id](#input\_application\_id) | Azure AD Application ID for federated identity credential (from backplane) | `string` | n/a | yes |

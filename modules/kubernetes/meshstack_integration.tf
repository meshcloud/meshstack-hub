...
variable "landing_zones" {
  ...
  nullable    = false
  description = "Landing zones created on the platform, keyed by name suffix."

  default = {
    dev = {
      display_name = "Kubernetes Namespace – Development"
    ...
    prod = {
      display_name = "Kubernetes Namespace – Production"
